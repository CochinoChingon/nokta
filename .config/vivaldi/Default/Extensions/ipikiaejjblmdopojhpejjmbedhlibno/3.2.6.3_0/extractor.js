...
//  ===============
    ...
    $D.parseOptions =
    {
        ...
        {
            'div': {'class':'|post-gallery|module|headline|yog-col|yom-figure|caption|comments-view|cnnExplainer|widget-container|email-subscription-promo|asset-metabar|story-asset|story-feature|comment-introduction|video-bar|shareArticles|article-reader-comments|mod-inline|chart|',
                    'id':'|connect|'}, //for wsj, yahoo, cnn, nyt
            'nav': {'id': '|next-in|'}
        },
