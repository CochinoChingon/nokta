if (!Int32Array.__proto__.from) {
  Object.defineProperty(Int32Array.__proto__, 'from', {
    value: function(obj) {
      ...
      for (var counter = 0; counter < typed_array.length; counter++) {
        typed_array[counter] = obj[counter];
      }
      return typed_array;
    }
  });
